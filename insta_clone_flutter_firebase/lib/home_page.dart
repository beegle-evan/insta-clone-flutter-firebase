...
class HomePage extends StatelessWidget {
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          SizedBox(
                            width: 70.0,
                            height: 70.0,
                            child: Image.network('https://cdn.pixabay.com/photo/2017/06/21/05/42/fog-2426131_1280.jpg',
                                fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.all(1.0),
  ...
  Widget _buildHasPostBody(List<DocumentSnapshot> documents) {
    // 내 게시물 5개
    final myPosts = documents.where((doc) => doc['email'] == user.email).take(5).toList();

    // 다른 사람 게시물 10개
    final otherPosts = documents.where((doc) => doc['email'] != user.email).take(10).toList();
